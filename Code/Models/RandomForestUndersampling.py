...
shap.summary_plot(shap_values[1], X_val_resampled)

#Display the decision plot for Risk_Flag=0
shap.decision_plot(explainer.expected_value[0], shap_values[0], X_val_resampled.columns, ignore_warnings=True)
